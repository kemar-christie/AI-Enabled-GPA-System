...
adminRoot= tk.Tk()
adminRoot.geometry("800x600")
adminRoot.title("Add a Student")
# Set the background color of the root window to white
adminRoot.configure(bg="white")

frame = tk.Frame(adminRoot, bg='white', bd=2, relief="solid", padx=20, pady=20)
...
submitButton = tk.Button(frame, text="Submit",font=("Arial", 12), padx=20, bg="#007bff",fg="white", width=6,command=validation)
